...
% mettiamo 0.05 di training set (95 di validation)
% e mettiamo epoch 50
...
[TrainingSet,ValidationSet]=splitEachLabel(imds,0.05,'randomize','true');
...
options = trainingOptions('sgdm','MiniBatchSize',200,'InitialLearnRate',0.001,'MaxEpochs',50,'ValidationPatience',Inf,'Plots','training-progress');
%options = trainingOptions('sgdm','MiniBatchSize',200,'InitialLearnRate',0.001,'MaxEpochs',800,'ValidationPatience',Inf);
