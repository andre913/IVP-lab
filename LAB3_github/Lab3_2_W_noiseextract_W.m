...
figure;
histogram(rho_sony_w,'FaceColor','r')
hold on
histogram(rho_other_w,'FaceColor','b')
legend('sony','others');
title('Normalized correlation histogram - sony pictures vs others - Wiener filter implemented');
grid on;
